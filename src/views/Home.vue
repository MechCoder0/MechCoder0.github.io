<template>
	<div>
		<div class="mid">
			...
			<p>
			Written, longform comedy. Who really has time for it? Among the call of the cellphone, TV, adds for Chinese food,
			and the ever present meme (pronounced mem), however, there is a call for entertainment which promps thought; entertainment
			which doesn't leave one feeling empty after it's gone. This web site has heard that call and reponded. Poorly.
			</p>
